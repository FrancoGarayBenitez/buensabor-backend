...
// LoggerFactory.getLogger(PedidoConMercadoPagoController.class);
...
// */
// @PostMapping("/crear")
// public ResponseEntity<PedidoConMercadoPagoResponseDTO>
// crearPedidoConMercadoPago(
...
// PedidoConMercadoPagoResponseDTO response =
// pedidoConMercadoPagoService.crearPedidoConMercadoPago(request);

// if (response.getExito()) {
// logger.info("✅ Pedido creado exitosamente: ID {}",
// response.getPedido().getIdPedido());
...
// PedidoConMercadoPagoResponseDTO errorResponse =
// PedidoConMercadoPagoResponseDTO.conError(
...
// public ResponseEntity<PedidoConMercadoPagoResponseDTO.CalculoTotalesDTO>
// calcularTotales(
// @Valid @RequestBody PedidoConMercadoPagoRequestDTO request) {

// try {
// logger.info("Calculando totales preview para tipo: {}",
// request.getTipoEnvio());
...
// "descripcion", "Sistema de pedidos con descuentos automáticos y MercadoPago
// integrado"
// );
...
// PedidoConMercadoPagoRequestDTO ejemplo = new
