...
// MovimientosMonetariosDTO movimientos =
// estadisticasService.findMovimientosMonetarios(fechaDesde, fechaHasta);
...
// List<RankingProductoDTO> ranking =
// estadisticasService.findRankingProductos(fechaDesde, fechaHasta, limit);
