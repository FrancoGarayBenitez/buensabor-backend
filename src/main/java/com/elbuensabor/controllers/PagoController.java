...
// @PostMapping
// public ResponseEntity<PagoResponseDTO> crearPago(@Valid @RequestBody
...
// public ResponseEntity<List<PagoResponseDTO>> getPagosByFactura(@PathVariable
// Long facturaId) {
...
// public ResponseEntity<List<PagoResponseDTO>> getPagosByEstado(@PathVariable
// EstadoPago estado) {
...
// getPagosByFormaPago(@PathVariable FormaPago formaPago) {
...
// public ResponseEntity<String> webhookMercadoPago(@RequestBody Map<String,
// Object> notification) {
// try {
...
// // Aquí deberías hacer una consulta a la API de MP para obtener los detalles
// completos
...
// public ResponseEntity<PagoResponseDTO> procesarReembolso(@PathVariable Long
// id) {
...
// public ResponseEntity<Double> getTotalPagadoFactura(@PathVariable Long
// facturaId) {
...
// public ResponseEntity<Double> getSaldoPendienteFactura(@PathVariable Long
// facturaId) {
...
// public ResponseEntity<Boolean> isFacturaCompletamentePagada(@PathVariable
// Long facturaId) {
// Boolean completamentePagada =
// pagoService.isFacturaCompletamentePagada(facturaId);
...
// String statusDetail = (String) request.getOrDefault("statusDetail",
// "accredited");
// Long paymentId = Long.valueOf(request.getOrDefault("paymentId",
// System.currentTimeMillis()).toString());

// logger.info("External Reference: {}, Status: {}, PaymentID: {}",
// externalReference, status, paymentId);

// if (externalReference == null || !externalReference.startsWith("PEDIDO_")) {
// throw new IllegalArgumentException("External reference debe empezar con
// 'PEDIDO_'");
// }

// // Extraer ID del pedido desde external reference (formato:
// "PEDIDO_18_timestamp")
...
// pagoRequest.setDescripcion("Pago simulado desde webhook - PaymentID: " +
// paymentId);
...
// FacturaResponseDTO facturaActualizada =
// facturaService.findById(factura.getIdFactura());
...
// public ResponseEntity<Map<String, Object>> confirmarPagoPedido(@RequestBody
...
// if (externalReference == null || !externalReference.startsWith("PEDIDO_")) {
// throw new IllegalArgumentException("External reference requerido (formato:
// PEDIDO_XX_timestamp)");
// }
...
// pagoRequest.setDescripcion("Pago confirmado manualmente - Ref: " +
// externalReference);
...
// pagoService.confirmarPagoMercadoPago(fakePaymentId, "approved",
// "accredited");

// // Obtener factura actualizada
// FacturaResponseDTO facturaFinal =
// facturaService.findById(factura.getIdFactura());
...
// public ResponseEntity<Map<String, Object>> confirmarPagoManual(@RequestBody
// Map<String, String> request) {
...
// result.put("success", false);
// result.put("error", "External reference requerido (debe contener
// 'PEDIDO_')");
// return ResponseEntity.status(400).body(result);
// }
...
// if (parts.length < 2) {
// throw new IllegalArgumentException("Formato de external reference
// incorrecto");
// }
...
// FacturaResponseDTO factura = pedidoService.getFacturaPedido(pedidoId);
// logger.info("Factura encontrada: ID {}, Total: ${}", factura.getIdFactura(),
...
// pagoRequest.setFormaPago(FormaPago.MERCADO_PAGO);
// pagoRequest.setMonto(factura.getSaldoPendiente());
// pagoRequest.setDescripcion("Pago confirmado manualmente - " +
// externalReference);
...
// PagoResponseDTO pagoAprobado =
// pagoService.actualizarEstadoPago(pagoCreado.getIdPago(),
// EstadoPago.APROBADO);
...
// public ResponseEntity<Map<String, Object>> debugPagosFactura(@PathVariable
// Long facturaId) {
...
// List<PagoResponseDTO> pagosFactura =
// pagoService.getPagosByFactura(facturaId);
