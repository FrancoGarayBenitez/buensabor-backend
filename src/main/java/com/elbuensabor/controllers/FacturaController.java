...
// @GetMapping("/{id}")
// public ResponseEntity<FacturaResponseDTO> getFacturaById(@PathVariable("id")
// Long id) {
...
// public ResponseEntity<FacturaResponseDTO> getFacturaByPedido(@PathVariable
// Long pedidoId) {
...
// public ResponseEntity<List<FacturaResponseDTO>>
// getFacturasByCliente(@PathVariable Long clienteId) {
// List<FacturaResponseDTO> facturas =
// facturaService.findByClienteId(clienteId);
// return ResponseEntity.ok(facturas);
// }
...
// fechaFin) {
// List<FacturaResponseDTO> facturas =
// facturaService.findByFechaRange(fechaInicio, fechaFin);
// return ResponseEntity.ok(facturas);
// }
...
// List<FacturaResponseDTO> facturas =
// facturaService.findFacturasPendientesPago();
// return ResponseEntity.ok(facturas);
// }
...
// public ResponseEntity<Boolean> existeFacturaParaPedido(@PathVariable Long
// pedidoId) {
...
// */
// @GetMapping("/{id}/pdf")
// public ResponseEntity<byte[]> descargarFacturaPdf(@PathVariable("id") Long
// id) {
// try {
...
// } catch (Exception e) {
// logger.error("Error generando PDF para factura {}: {}", id, e.getMessage(),
// e);
...
// public ResponseEntity<byte[]> descargarFacturaPdfByPedido(@PathVariable Long
// pedidoId) {
// try {
...
// } catch (Exception e) {
// logger.error("Error generando PDF para pedido {}: {}", pedidoId,
// e.getMessage(), e);
// return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).build();
// }
// }
...
// public ResponseEntity<byte[]> previsualizarFacturaPdf(@PathVariable("id")
// Long id) {
// try {
...
// } catch (Exception e) {
// logger.error("Error generando preview PDF para factura {}: {}", id,
// e.getMessage(), e);
// return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).build();
// }
// }
