...
// @Mapping(target = "stockSuficiente", ignore = true) // Se calcula en el
// service
// @Mapping(target = "tiempoEstimadoTotal", ignore = true) // Se calcula en el
// service
...
// @Mapping(target = "horaEstimadaFinalizacion", ignore = true) // Se calcula en
// el service
...
// @Mapping(target = "totalCosto", ignore = true) // ← AGREGADO para quitar
// warning
...
// void updateEntityFromDTO(PedidoResponseDTO dto, @MappingTarget Pedido
// entity);
// }