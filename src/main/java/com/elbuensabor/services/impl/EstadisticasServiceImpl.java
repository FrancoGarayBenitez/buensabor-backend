...
// @Autowired
// private IDetallePedidoRepository detallePedidoRepository; // <-- Inyectamos
// el nuevo repositorio

// @Override
// public MovimientosMonetariosDTO findMovimientosMonetarios(LocalDate
...
// Double ingresos = facturaRepository.getTotalVentasByPeriodo(fechaDesde,
// fechaHasta);
// if (ingresos == null) {
// ingresos = 0.0;
// }
...
// List<com.elbuensabor.entities.Pedido> pedidosEnRango =
// pedidoRepository.findByFechaBetween(inicio, fin);
// Double costos = pedidosEnRango.stream()
// .filter(pedido -> pedido.getEstado() !=
// com.elbuensabor.entities.Estado.CANCELADO)
...
// @Override
// public List<RankingProductoDTO> findRankingProductos(LocalDate fechaDesde,
// LocalDate fechaHasta, Integer limit) {
// LocalDateTime inicio = fechaDesde.atStartOfDay();
// LocalDateTime fin = fechaHasta.atTime(LocalTime.MAX);
